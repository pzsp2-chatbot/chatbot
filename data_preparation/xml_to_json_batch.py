...
class AuthorProcessor:
    ...
    def _extract_single_author(self, author_element: ET.Element) -> Dict[str, Optional[str]]:
    ...
    def _extract_affiliation(self, author_element: ET.Element) -> Optional[str]:
        return (
            author_element.findtext("externalAuthorAffiliation/fullNameEN") or
            author_element.findtext("externalAuthorAffiliation/fullName")
        )
